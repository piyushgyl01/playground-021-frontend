...
import { BsThreeDotsVertical, BsCollection, BsCalendarDate, BsPlus } from 'react-icons/bs';
    ...
    return (
      <div className="container py-5">
        <div className="alert alert-danger shadow-sm" role="alert">
          ...
          <p>{error || "There was a problem loading your albums. Please try again later."}</p>
        </div>
      </div>
    );
  }
        ...
        <div className="col-12">
          <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
            <div>
              ...
              <p className="text-muted mb-0">Organize and browse your memories</p>
            </div>
            <Link 
              to="/create-album" 
              ...
              <div key={album._id} className="col-lg-4 col-md-6 mb-4">
                <div className="card h-100 border-0 shadow-sm hover-shadow">
                  <div 
                    ...
                    style={{ 
                      backgroundImage: album.albumCover ? `url(${album.albumCover})` : null,
                      backgroundColor: !album.albumCover ? (album.coverColor || getRandomColor()) : null,
                    ...
                    <div className="position-absolute top-0 end-0 mt-2 me-2">
                      <div className="dropdown">
                        ...
                        <ul className="dropdown-menu dropdown-menu-end shadow-sm">
                          <li>
                            <Link to={`/create-album`} state={album} className="dropdown-item">
                              <i className="bi bi-pencil me-2"></i> Edit Album
                            </Link>
                          </li>
                          <li><hr className="dropdown-divider" /></li>
                          <li>
                            <button className="dropdown-item text-danger" onClick={() => handleDelete(album._id)}>
            ...
            <div className="card border-0 shadow-sm text-center py-5">
              <div className="card-body">
                ...
                <p className="card-text text-muted mb-4">
                  ...
                  You can add photos, descriptions, and share with friends and family.
                </p>
